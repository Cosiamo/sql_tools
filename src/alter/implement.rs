use crate::{create::CreateDataTypes, Error, SQLVariation};

use super::{oracle_sql::alter, AlterBuilder, AlterColumns, AlterProps, AlterTable, AlterTableBuilder, Altered};
