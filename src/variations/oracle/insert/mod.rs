...
use crate::{clauses::create::{CreateColumns, CreateDataTypes, ModifyCreateTable}, data_types::SQLDataTypes, variations::utils::get_dt_indices, Error, QueryBuilder, SQLVariation};
...
pub(crate) fn oracle_build_insert(mut insert_props: InsertProps, use_pb: bool) -> Result<(), Error> {
